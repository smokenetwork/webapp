                ...
                <div className="column large-12">
                    ...
                    <div>
                        ...
                        <p>
                            ...
                            If you have not already created a Smoke account, create an account on the Smoke blockchain <a href="/pick_account" target="_blank">now</a>.
                        </p>
                        <p>
                            <span className="section">2: </span>
                            Go to our claim tool and follow the instructions: <a href="https://claim.smoke.io/" target="_blank">https://claim.smoke.io/</a>
                        </p>
                    </div>
                    <br />
                    <div>
                        ...
                        <p>
                            <span className="section">2: </span>
                            Sign into your Smoke ICO dashboard (<a href="https://ico.smoke.network/user/" target="_blank">https://ico.smoke.network/user/</a>) and click `My Profile` and then `My Wallet`.
                        </p>
                        <p>
