...
class Market extends React.Component {
    ...
    render() {
        ...
        const {
            ...
            buy_price_warning, sell_price_warning
        } = this.state
                ...
                <div className="row">
                    <div className="column">
                        <ul className="Market__ticker">
                            <li>
                                <b>{tt('market_jsx.last_price')}</b> {CURRENCY_SIGN}{ticker.latest.toFixed(6)} ({pct_change})
                            </li>
                            ...
                            <li>
                                <b>{tt('market_jsx.spread')}</b> {(200 * (ticker.lowest_ask - ticker.highest_bid) / (ticker.highest_bid + ticker.lowest_ask)).toFixed(3)}%
                            </li>}
                    ...
                    <div className="small-12 medium-6 columns">
                        ...
                        <form className="Market__orderform" onSubmit={buySteem}>
                            ...
                            <div className="row">
                                ...
                                <div className="column small-9 large-8">
                                    <input disabled={buy_disabled} type="submit"
                                           className="button hollow buy-color float-right uppercase"
                                           value={tt('navigation.buy_LIQUID_TOKEN', {LIQUID_TOKEN})}/>
                                    {account &&
                                    <div>
                                        <small>
                                            <a href="#" onClick={e => {
                    ...
                    <div className="small-12 medium-6 columns">
                        ...
                        <form className="Market__orderform" onSubmit={sellSteem}>
                            ...
                            <div className="row">
                                ...
                                <div className="column small-9 large-8">
                                    <input disabled={sell_disabled} type="submit"
                                           className="button hollow sell-color float-right uppercase"
                                           value={tt('navigation.sell_LIQUID_TOKEN', {LIQUID_TOKEN})}/>
                                    {account &&
                                    <div>
