            ...
            <form onSubmit={handleSubmit(data => {
                ...
                <div className="row">
                    <div className="small-12 columns">
                        ...
                        <p>{tt('converttosteem_jsx.your_existing_DEBT_TOKEN_are_liquid_and_transferable', {
                            link: tt('g.buy_or_sell'),
                            DEBT_TOKEN
                        })}</p>
                ...
                <div className="row">
                    <div className="small-12 columns">
                        ...
                        <input type="amount" ref="amt" {...cleanReduxInput(amount)} autoComplete="off"
                               disabled={loading}/>
                        &nbsp;
                        {DEBT_TOKEN}
                        <br/>
                ...
                <div className="row">
                    <div className="small-12 columns">
                        ...
                        <div>
                            ...
                            <button type="button" disabled={submitting} className="button hollow float-right"
                                    onClick={onClose}>
                                {tt('g.cancel')}
                            </button>
                        </div>
