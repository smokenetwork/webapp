...
export const local = (flags = 'i') => new RegExp(urlSet({domain: '(?:localhost|(?:.*\\.)?smoke.io)'}), flags)
export const remote = (flags = 'i') => new RegExp(urlSet({domain: `(?!localhost|(?:.*\\.)?smoke.io)${domainPath}`}), flags)
...
export default {
  ...
  spotifyId: /(?:spotify.com\/|open.spotify.com\/)([A-Za-z0-9\_\-\/]+)/i,
